...
def _main():
    train_path = 'model_data/train_kuo.txt'
    val_path = 'car_val.txt'
    log_dir = 'logs/MobileNetV2_0.5_224_layerShort/'
    ...
    if is_tiny_version:
        ...
        model = create_model(input_shape, anchors, num_classes, load_pretrained=False,
                             weights_path='logs/MobileNetV2_0.75_224_layerShort/trained_weights_final.h5',
...
def create_model(input_shape, anchors, num_classes, load_pretrained=False, freeze_body=2,
                 weights_path='logs/MobileNetV1_0.75_320/ep024-loss10.298-val_loss10.189.h5'):
...
def create_tiny_model(input_shape, anchors, num_classes, load_pretrained=True, freeze_body=2,
    ...
    if load_pretrained:
        ...
        print('Load weights {}.'.format(weights_path))
        if freeze_body in [1, 2]:
            # Freeze the darknet_416 body or freeze all but 2 output layers.
